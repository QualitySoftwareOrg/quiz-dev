...
export default function QuizScreen() {
  ...
  const avancarPergunta = useCallback(() => {
    ...
    setPowerUps((prev) => ({
      ...prev,
      cinquentaCinquenta: { ...prev.cinquentaCinquenta, usado: false },
    }));
  ...
  }, [acertos, categoria, dificuldade, indice, navigation, tempoBase, tempoAnimado, pulseAnim, totalPerguntas]);
    ...
    async function carregarPerguntas() {
      ...
      try {
        const res = await api.get(
          `/perguntas/categoria?categoria=${encodeURIComponent(categoria)}&dificuldade=${encodeURIComponent(dificuldade)}`
        );
  ...
  }, [perguntas, indice, tempoBase, fadeAnim, slideAnim, tempoAnimado]);
  ...
  }, [respostaSelecionada, totalPerguntas, avancarPergunta, tempoBase, pulseAnim]);
  ...
  }, [respostaSelecionada, alternativas, tempo, avancarPergunta, pontosAnim, tempoAnimado]);
